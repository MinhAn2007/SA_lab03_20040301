...
public class XML2Doc {
    ...
    public static void main(String[] args) {
        try {
            // Step 1: Parse the XML file generated by JDepend
            DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
            DocumentBuilder builder = factory.newDocumentBuilder();
            File xmlFile = new File("jdepend-results.xml");
    ...
    private static void generateReport(Document document) {
        try (PrintWriter out = new PrintWriter(new FileOutputStream("jdepend.txt"))) {
